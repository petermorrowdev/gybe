...
class LimitedPriorityLevelConfiguration(K8sResource):
    ...
    Attributes:
        ...
        nominalConcurrencyShares: `nominalConcurrencyShares` (NCS) contributes to the computation of the
            ...
            NCS values:  NominalCL(i)  = ceil( ServerCL * NCS(i) / sum_ncs ) sum_ncs = sum[limited priority
            level k] NCS(k)  Bigger numbers mean a larger nominal concurrency limit, at the expense of every

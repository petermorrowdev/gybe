...
class Eviction(K8sSpec):
    ...
    deleteOptions: Optional[gybe.k8s.v1_26.meta.v1.DeleteOptions] = None
...
class PodDisruptionBudgetSpec(K8sSpec):
    ...
    ----------
        ...
        unhealthyPodEvictionPolicy: UnhealthyPodEvictionPolicy defines the criteria for when unhealthy pods
            ...
            this field.  This field is alpha-level. The eviction API uses this field when the feature gate
            PDBUnhealthyPodEvictionPolicy is enabled (disabled by default).

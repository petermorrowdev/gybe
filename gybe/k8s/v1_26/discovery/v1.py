...
class Endpoint(K8sSpec):
    ...
    targetRef: Optional[gybe.k8s.v1_26.core.v1.ObjectReference] = None
...
class EndpointPort(K8sSpec):
    ...
    Attributes:
        ...
        name: The name of this port. All ports in an EndpointSlice must have a unique name. If the
            EndpointSlice is dervied from a Kubernetes service, this corresponds to the Service.ports[].name.
        ...
        port: The port number of the endpoint. If this is not specified, ports are not restricted and must be

...
class EmptyDirVolumeSource(K8sSpec):
    ...
    sizeLimit: Optional[gybe.k8s.v1_28.api.resource.Quantity] = None
...
class PodAffinityTerm(K8sSpec):
    ...
    topologyKey: str
    labelSelector: Optional[gybe.k8s.v1_28.meta.v1.LabelSelector] = None
    namespaceSelector: Optional[gybe.k8s.v1_28.meta.v1.LabelSelector] = None
...
class ResourceFieldSelector(K8sSpec):
    ...
    divisor: Optional[gybe.k8s.v1_28.api.resource.Quantity] = None
...
class EndpointPort(K8sSpec):
    ...
    Attributes:
        appProtocol: The application protocol for this port. This is used as a hint for implementations to
            ...
            https://www.rfc-editor.org/rfc/rfc7540   * 'kubernetes.io/ws'  - WebSocket over cleartext as
            described in https://www.rfc-editor.org/rfc/rfc6455   * 'kubernetes.io/wss' - WebSocket over TLS
            as described in https://www.rfc-editor.org/rfc/rfc6455  * Other protocols should use
...
class Event(K8sSpec):
    ...
    metadata: gybe.k8s.v1_28.meta.v1.ObjectMeta
...
class PersistentVolumeStatus(K8sSpec):
    ...
    Attributes:
        lastPhaseTransitionTime: lastPhaseTransitionTime is the time the phase transitioned from one to
            another and automatically resets to current time everytime a volume phase transitions. This is an
...
class PodResourceClaimStatus(K8sSpec):
    ...
    Attributes:
        ...
        resourceClaimName: ResourceClaimName is the name of the ResourceClaim that was generated for the Pod
            in the namespace of the Pod. It this is unset, then generating a ResourceClaim was not necessary.
...
class ServiceStatus(K8sSpec):
    ...
    conditions: Optional[List[gybe.k8s.v1_28.meta.v1.Condition]] = None

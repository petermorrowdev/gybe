...
class IngressBackend(K8sSpec):
    ...
    resource: Optional[gybe.k8s.v1_28.core.v1.TypedLocalObjectReference] = None
...
class NetworkPolicyPeer(K8sSpec):
    ...
    podSelector: Optional[gybe.k8s.v1_28.meta.v1.LabelSelector] = None
...
class NetworkPolicySpec(K8sSpec):
    ...
    podSelector: gybe.k8s.v1_28.meta.v1.LabelSelector

...
class CronJobStatus(K8sSpec):
    ...
    active: Optional[List[gybe.k8s.v1_34.core.v1.ObjectReference]] = None
...
class JobSpec(K8sSpec):
    ...
    Attributes:
        ...
        backoffLimit: Specifies the number of retries before marking this job failed. Defaults to 6, unless
            backoffLimitPerIndex (only Indexed Job) is specified. When backoffLimitPerIndex is specified,
            backoffLimit defaults to 2147483647.
        ...
        podReplacementPolicy: podReplacementPolicy specifies when to create replacement Pods. Possible values
            ...
            values when podFailurePolicy is not in use.
    ...
    template: gybe.k8s.v1_34.core.v1.PodTemplateSpec
...
class SuccessPolicy(K8sSpec):
    ...
    Attributes:
        rules: rules represents the list of alternative rules for the declaring the Jobs as successful before
            `.status.succeeded >= .spec.completions`. Once any of the rules are met, the 'SuccessCriteriaMet'

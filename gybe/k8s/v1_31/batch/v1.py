...
class CronJobStatus(K8sSpec):
    ...
    active: Optional[List[gybe.k8s.v1_31.core.v1.ObjectReference]] = None
...
class JobSpec(K8sSpec):
    ...
    Attributes:
        ...
        managedBy: ManagedBy field indicates the controller that manages a Job. The k8s Job controller
            ...
            field is immutable.  This field is alpha-level. The job controller accepts setting the field when

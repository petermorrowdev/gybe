...
class CSIPersistentVolumeSource(K8sSpec):
    ...
    ----------
        ...
        nodeExpandSecretRef: nodeExpandSecretRef is a reference to the secret object containing sensitive
            information to pass to the CSI driver to complete the CSI NodeExpandVolume call. This is a beta
            field which is enabled default by CSINodeExpandSecret feature gate. This field is optional, may be
...
class EmptyDirVolumeSource(K8sSpec):
    ...
    sizeLimit: Optional[gybe.k8s.v1_27.api.resource.Quantity] = None
...
class PersistentVolumeClaimSpec(K8sSpec):
    ...
    resources: Optional[ResourceRequirements] = None
    selector: Optional[gybe.k8s.v1_27.meta.v1.LabelSelector] = None
    storageClassName: Optional[str] = None
    volumeMode: Optional[str] = None
    volumeName: Optional[str] = None
...
class PodAffinityTerm(K8sSpec):
    ...
    topologyKey: str
    labelSelector: Optional[gybe.k8s.v1_27.meta.v1.LabelSelector] = None
    namespaceSelector: Optional[gybe.k8s.v1_27.meta.v1.LabelSelector] = None
...
class ResourceFieldSelector(K8sSpec):
    ...
    divisor: Optional[gybe.k8s.v1_27.api.resource.Quantity] = None
...
class EndpointPort(K8sSpec):
    ...
    ----------
        appProtocol: The application protocol for this port. This is used as a hint for implementations to
            ...
            defined prefixed names:   * 'kubernetes.io/h2c' - HTTP/2 over cleartext as described in
            https://www.rfc-editor.org/rfc/rfc7540  * Other protocols should use implementation-defined
...
class Event(K8sSpec):
    ...
    metadata: gybe.k8s.v1_27.meta.v1.ObjectMeta
...
class ServiceStatus(K8sSpec):
    ...
    conditions: Optional[List[gybe.k8s.v1_27.meta.v1.Condition]] = None

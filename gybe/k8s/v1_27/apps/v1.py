...
class DaemonSetSpec(K8sResource):
    ...
    selector: gybe.k8s.v1_27.meta.v1.LabelSelector
    template: gybe.k8s.v1_27.core.v1.PodTemplateSpec
...
class ReplicaSetSpec(K8sResource):
    ...
    minReadySeconds: Optional[int] = None
    replicas: Optional[int] = None
    template: Optional[gybe.k8s.v1_27.core.v1.PodTemplateSpec] = None
...
class StatefulSetSpec(K8sResource):
    ...
    volumeClaimTemplates: Optional[List[gybe.k8s.v1_27.core.v1.PersistentVolumeClaim]] = None

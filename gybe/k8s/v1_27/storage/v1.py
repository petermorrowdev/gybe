...
class CSIStorageCapacity(K8sSpec):
    ...
    apiVersion: Optional[str] = None
    capacity: Optional[gybe.k8s.v1_27.api.resource.Quantity] = None
    kind: Optional[str] = None
    maximumVolumeSize: Optional[gybe.k8s.v1_27.api.resource.Quantity] = None
    metadata: Optional[gybe.k8s.v1_27.meta.v1.ObjectMeta] = None
    nodeTopology: Optional[gybe.k8s.v1_27.meta.v1.LabelSelector] = None
...
class StorageClass(K8sSpec):
    ...
    allowedTopologies: Optional[List[gybe.k8s.v1_27.core.v1.TopologySelectorTerm]] = None
    apiVersion: Optional[str] = None
    kind: Optional[str] = None
    metadata: Optional[gybe.k8s.v1_27.meta.v1.ObjectMeta] = None
...
class VolumeAttachmentSource(K8sSpec):
    ...
    inlineVolumeSpec: Optional[gybe.k8s.v1_27.core.v1.PersistentVolumeSpec] = None

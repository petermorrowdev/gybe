...
class IngressBackend(K8sResource):
    ...
    resource: Optional[gybe.k8s.v1_27.core.v1.TypedLocalObjectReference] = None
...
class NetworkPolicy(K8sResource):
    ...
    Attributes:
        ...
        status: status represents the current state of the NetworkPolicy.
...
class NetworkPolicyPeer(K8sResource):
    ...
    podSelector: Optional[gybe.k8s.v1_27.meta.v1.LabelSelector] = None
...
class NetworkPolicySpec(K8sResource):
    ...
    podSelector: gybe.k8s.v1_27.meta.v1.LabelSelector

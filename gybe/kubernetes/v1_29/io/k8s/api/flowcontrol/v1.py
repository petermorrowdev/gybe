...
class LimitedPriorityLevelConfiguration(BaseModel):
    ...
    nominalConcurrencyShares: Optional[int] = Field(
        ...
        description=(
            ...
            " expense of every other priority level.\n\nIf not specified, this field"
            " defaults to a value of 30.\n\nSetting this field to zero supports the"
            ' construction of a "jail" for this priority level that is used to hold'
            " some request(s)"
        ),
    )

...
class JobStatus(BaseModel):
    ...
    failedIndexes: Optional[str] = Field(
        ...
        description=(
            ...
            " field is alpha-level. It can be used when the `JobBackoffLimitPerIndex`"
    ...
    terminating: Optional[int] = Field(
        ...
        description=(
            ...
            " have a deletionTimestamp).\n\nThis field is alpha-level. The job"
...
class JobSpec(BaseModel):
    ...
    maxFailedIndexes: Optional[int] = Field(
        ...
        description=(
            ...
            " when is completions greater than 10^5. This field is alpha-level. It can"
    ...
    podReplacementPolicy: Optional[str] = Field(
        ...
        description=(
            ...
            " podFailurePolicy is not in use. This is an alpha field. Enable"

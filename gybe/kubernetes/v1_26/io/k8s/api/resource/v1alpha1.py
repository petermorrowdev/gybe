...
class PodSchedulingSpec(BaseModel):
...
class AllocationResult(BaseModel):
    availableOnNodes: Optional[v1.NodeSelector] = Field(
        ...
        description=(
            ...
            " resource driver to inform the scheduler where it can schedule Pods using"
            " the ResourceClaim.\n\nSetting this field is optional. If null, the"
            " resource is available everywhere."
        ),
    )
    resourceHandle: Optional[str] = Field(
        None,
        description=(
            ...
            " documentation may explain to users how to interpret this data if"
...
class PodSchedulingStatus(BaseModel):
...
class PodSchedulingList(BaseModel):
    ...
    items: List[PodScheduling] = Field(

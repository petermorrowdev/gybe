...
class JobStatus(BaseModel):
    ...
    uncountedTerminatedPods: Optional[UncountedTerminatedPods] = Field(
        ...
        description=(
            ...
            " beta-level. The job controller only makes use of this field when the"
            " feature gate JobTrackingWithFinalizers is enabled (enabled by default)."
...
class JobSpec(BaseModel):
    ...
    podFailurePolicy: Optional[PodFailurePolicy] = Field(
        ...
        description=(
            ...
            " is alpha-level. To use this field, you must enable the"
